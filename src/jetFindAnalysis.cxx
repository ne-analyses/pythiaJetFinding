...
int main( int argc, const char** argv ) {
  ...
  TH2D* timeAntiKt = new TH2D("antiktclustertime", "Time Required to cluster - Anti-Kt", nRadii, -0.5, nRadii-0.5, 500, -0.5, 9999.5);
  ...
  TH2D* timeKt = new TH2D("ktclustertime", "Time Required to cluster - Kt", nRadii, -0.5, nRadii-0.5, 500, -0.5, 9999.5);
  ...
  TH2D* timeCa = new TH2D("caclustertime", "Time Required to cluster - CA", nRadii, -0.5, nRadii-0.5, 500, -0.5, 9999.5);
