...
int main( int argc, const char** argv ) {
  ...
  // antikt
  TH2D* nJetsAntiKt = new TH2D( "antiktnjets", "Number of Jets - Anti-Kt", nRadii, -0.5, nRadii-0.5, 250, -0.5, 999.5 );
  ...
  // kt
  TH2D* nJetsKt = new TH2D( "ktnjets", "Number of Jets - Kt", nRadii, -0.5, nRadii-0.5, 250, -0.5, 999.5 );;
  ...
  // cambridge
  TH2D* nJetsCa = new TH2D( "canjets", "Number of Jets - CA", nRadii, -0.5, nRadii-0.5, 250, -0.5, 999.5 );
